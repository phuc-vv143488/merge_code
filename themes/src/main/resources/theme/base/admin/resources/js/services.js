...
module.factory('ComponentUtils', function() {
    ...
    // SP_POSITION
    utils.sortPositions = sortPositions;
    function sortPositions(prop, arr) {
        // sort current elements
        arr.sort(function (a, b) {
            if (a[prop] < b[prop]) { return -1; }
            if (a[prop] > b[prop]) { return 1; }
...
// SP_POSITION
module.factory('Position', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId', {
        realm : '@realm',
        posId : '@posId'
    }, {
        update : {
...
module.service('PositionSearchState', function() {
    this.isFirstSearch = true;
    this.query = {
        max : 20,
        first : 0
...
module.service('PositionMemberSearchState', function() {
    this.isFirstSearch = true;
    this.query = {
        max : 20,
        first : 0
...
module.factory('PositionRealmRoleMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/role-mappings/realm', {
        realm : '@realm',
        posId : '@posId'
    });
});

module.factory('PositionCompositeRealmRoleMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/role-mappings/realm/composite', {
        realm : '@realm',
        posId : '@posId'
    });
});

module.factory('PositionAvailableRealmRoleMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/role-mappings/realm/available', {
        realm : '@realm',
        posId : '@posId'
    });
});
...
module.factory('PositionClientRoleMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/role-mappings/clients/:client', {
        realm : '@realm',
        posId : '@posId',
        client : "@client"
    });
...
module.factory('PositionAvailableClientRoleMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/role-mappings/clients/:client/available', {
        realm : '@realm',
        posId : '@posId',
        client : "@client"
    });
...
module.factory('PositionCompositeClientRoleMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/role-mappings/clients/:client/composite', {
        realm : '@realm',
        posId : '@posId',
        client : "@client"
    });
...
module.factory('PositionMembership', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/members', {
        realm : '@realm',
        posId : '@posId'
    });
});
...
module.factory('PositionDeleteUser', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions/:posId/members/delete', {
            realm : '@realm',
            posId : '@posId',
            userId: '@userId'
        });
...
module.factory('Positions', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/positions', {
        realm : '@realm'
    })
});

module.factory('UserPositionMembership', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/users/:userId/positions', {
        realm : '@realm',
        userId : '@userId'
    });
});

module.factory('UserPositionMapping', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/users/:userId/positions/:posId', {
        realm : '@realm',
        userId : '@userId',
        posId : '@posId'
    }, {
...
module.factory('UserPositionMembershipCount', function($resource) {
    return $resource(authUrl + '/admin/realms/:realm/users/:userId/positions/count', {
            realm : '@realm',
            userId : '@userId'
        },
        {
