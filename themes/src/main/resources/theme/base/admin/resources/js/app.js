...
module.config([ '$routeProvider', function($routeProvider) {
    $routeProvider
        ...
        // SP_POSITION
        .when('/realms/:realm/users/:user/positions', {
            templateUrl : resourceUrl + '/partials/user-position-membership.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
            ...
            controller : 'UserPositionMembershipCtrl'
        })
        .when('/realms/:realm/positions', {
            templateUrl : resourceUrl + '/partials/position-list.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                }
        ...
        .when('/create/position/:realm', {
            templateUrl : resourceUrl + '/partials/position-detail.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
        ...
        .when('/realms/:realm/positions/:position', {
            templateUrl : resourceUrl + '/partials/position-detail.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
                position : function(PositionLoader) {
                    return PositionLoader();
                }
            },
            controller : 'PositionDetailCtrl'
        })
        /* Đường dẫn đủ: /realms/:realm/positions/:position/attributes */
        .when('/realms/:realm/positions/:position/attributes', {
            templateUrl : resourceUrl + '/partials/position-attributes.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
        ...
        .when('/realms/:realm/positions/:position/members', {
            templateUrl : resourceUrl + '/partials/position-members.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
            ...
            controller : 'PositionMembersCtrl'
        })
        .when('/realms/:realm/positions/:position/role-mappings', {
            templateUrl : resourceUrl + '/partials/position-role-mappings.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
            ...
            controller : 'PositionRoleMappingCtrl'
        })
...
// SP_POSITION
module.directive('kcTabsPositionList', function () {
    return {
        scope: true,
        restrict: 'E',
        replace: true,
        templateUrl: resourceUrl + '/templates/kc-tabs-position-list.html'
    }
});
module.directive('kcTabsPosition', function () {
    return {
        scope: true,
        restrict: 'E',
        replace: true,
        templateUrl: resourceUrl + '/templates/kc-tabs-position.html'
    }
});
// SP_POSITION
// SP_POSITION
