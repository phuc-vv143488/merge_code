...
module.config(['$routeProvider', function ($routeProvider) {
    $routeProvider
        ...
        controller: 'PolicyEvaluateCtrl'
    }).when('/realms/:realm/clients/:client/authz/resource-server/menu', {
        templateUrl: resourceUrl + '/partials/authz/menu-server-menu-list.html',
        resolve: {
            realm: function (RealmLoader) {
                return RealmLoader();
            },
    ...
    }).when('/realms/:realm/clients/:client/authz/resource-server/menu/create/parent/:parentId', {
        templateUrl : resourceUrl + '/partials/authz/create-menu-detail.html',
        resolve : {
            realm : function(RealmLoader) {
                return RealmLoader();
            },
        ...
        controller : 'MenuResourceCreateCtrl'
    }).when('/realms/:realm/clients/:client/authz/resource-server/menu/groups/:group', {
        templateUrl : resourceUrl + '/partials/authz/menu-detail.html',
        resolve : {
            realm : function(RealmLoader) {
                return RealmLoader();
            },
        ...
        controller: 'ResourceServerResourceDetailCtrl'
    }).when('/realms/:realm/clients/:client/authz/resource-server/menu/:rsrid', {
        templateUrl: resourceUrl + '/partials/authz/menu-server-menu-detail.html',
        resolve: {
            realm: function (RealmLoader) {
                return RealmLoader();
            },
        ...
        // SP_POSITION
        .when('/realms/:realm/clients/:client/authz/resource-server/policy/position/create', {
            templateUrl: resourceUrl + '/partials/authz/policy/provider/resource-server-policy-position-detail.html',
            resolve: {
                realm: function (RealmLoader) {
                    return RealmLoader();
                },
            ...
            controller: 'ResourceServerPolicyPositionDetailCtrl'
        }).when('/realms/:realm/clients/:client/authz/resource-server/policy/position/:id', {
            templateUrl: resourceUrl + '/partials/authz/policy/provider/resource-server-policy-position-detail.html',
            resolve: {
                realm: function (RealmLoader) {
                    return RealmLoader();
