...
function getAccessObject(Auth, Current) {
    return {
        ...
        // SP_POSITION
        get queryPositions() {
            return getAccess(Auth, Current, 'query-positions') || this.viewPositions;
        },

        get viewPositions() {
            return getAccess(Auth, Current, 'view-positions') || getAccess(Auth, Current, 'manage-positions') || this.managePositions;
        },

        get managePositions() {
            return getAccess(Auth, Current, 'manage-positions');
        },
        // SP_POSITION
