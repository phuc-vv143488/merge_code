...
public interface UserStorageProvider extends Provider {
    ...
    /**
     * Callback when a position is removed.  Allows you to do things like remove a user
     * position mapping in your external store if appropriate
     *
     * @param realm
     * @param position
     * SP_POSITION
     */
    default
    void preRemove(RealmModel realm, PositionModel position) {
