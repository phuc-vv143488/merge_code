...
//    void setPersistUserSessions();
    ...
    // SP_POSITION
    PositionModel createPosition(PositionRepresentation rep);

    List<PositionModel> searchForPositionByName(String search, Integer first, Integer max);

    List<PositionModel> searchForPositionByNameAndCode(String searchName, String searchCode, Integer first, Integer max);
