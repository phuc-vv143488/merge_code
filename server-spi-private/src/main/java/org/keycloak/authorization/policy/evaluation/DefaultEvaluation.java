...
public class DefaultEvaluation implements Evaluation {
    ...
    private Realm createRealm() {
        return new Realm() {
            ...
            // SP_POSITION
            @Override
            public String getUserPosition(String id) {
                PositionModel positionModel = getUser(id, authorizationProvider.getKeycloakSession()).getPosition();
                if (positionModel == null) return null;
                return positionModel.getPosName();
            }
            // SP_POSITION
