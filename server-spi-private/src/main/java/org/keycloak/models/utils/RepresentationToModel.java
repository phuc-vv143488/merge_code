...
public class RepresentationToModel {
    ...
    public static UserModel createUser(KeycloakSession session, RealmModel newRealm, UserRepresentation userRep) {
        ...
        // SP_POSITION
        createOrUpdatePosition(userRep, newRealm, user);
        // SP_POSITION
        return user;
    }

    // SP_POSITION
    public static void deletePositions(UserModel user) {
    ...
    public static void createOrUpdatePosition(UserRepresentation userRep, RealmModel newRealm, UserModel user) {
        if (userRep.getPositionId() != null) {
            ...
            if (position == null) {
                throw new RuntimeException("Unable to find position specified by id: " + userRep.getPositionId());

            }
            user.joinPosition(position.getPosId());
        } else {
            user.leavePosition();
        }
    }
