...
public class AdminRoles {
    ...
    // SP_POSITION
    public static String QUERY_POSITIONS = "query-positions";
    public static String VIEW_POSITIONS = "view-positions";
    public static String MANAGE_POSITIONS = "manage-positions";
    // SP_POSITION
    
    //ADMIN_FULL
    public static String ADMIN_FULL = "admin-full";
    //ADMIN_FULL
    ...
    public static String[] ALL_REALM_ROLES = {CREATE_CLIENT, VIEW_REALM, VIEW_USERS, VIEW_CLIENTS, VIEW_EVENTS, VIEW_IDENTITY_PROVIDERS, VIEW_AUTHORIZATION, MANAGE_REALM, MANAGE_USERS, MANAGE_CLIENTS, MANAGE_EVENTS, MANAGE_IDENTITY_PROVIDERS, MANAGE_AUTHORIZATION, QUERY_USERS, QUERY_CLIENTS, QUERY_REALMS, QUERY_GROUPS,
            QUERY_POSITIONS, VIEW_POSITIONS, MANAGE_POSITIONS, ADMIN_FULL};
