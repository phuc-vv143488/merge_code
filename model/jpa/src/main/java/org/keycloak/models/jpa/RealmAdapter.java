...
public class RealmAdapter implements RealmModel, JpaModel<RealmEntity> {
    ...
    // SP_POSITION
    @Override
    public PositionModel createPosition(PositionRepresentation rep) {
        return session.realms().createPosition(this, rep);
    }
    @Override
    public List<PositionModel> searchForPositionByName(String search, Integer first, Integer max) {
        return session.realms().searchForPositionByName(this, search, first, max);
    }

    @Override
    public List<PositionModel> searchForPositionByNameAndCode(String searchName, String searchCode, Integer first, Integer max) {
        return session.realms().searchForPositionByNameAndCode(this, searchName, searchCode, first, max);
    }

    @Override
    public List<Integer> checkPositionByNameAndCode(String searchName, String searchCode) {
        return session.realms().checkPositionByNameAndCode(this , searchName, searchCode);
    }

    @Override
    public PositionModel getPositionById(String id) {
        return session.realms().getPositionById(id, this);
    }
    @Override
    public boolean removePosition(PositionModel position) {
        return session.realms().removePosition(this, position);
    }
    @Override
