...
public class GroupAdapter implements GroupModel {
	...
	public void setContactName(String contactName) {
		getDelegateForUpdate();
		updated.setContactName(contactName);
	}

	@Override
	public void setContactTitle(String contactTitle) {
		getDelegateForUpdate();
		updated.setContactTitle(contactTitle);
	}
	...
	public void setDeptTypeId(Long deptTypeId) {
		getDelegateForUpdate();
		updated.setDeptTypeId(deptTypeId);
	...
	public void setDeptLevel(String deptLevel) {
		getDelegateForUpdate();
		updated.setDeptLevel(deptLevel);
	...
	public void setFullDeptName(String fullDeptName) {
		getDelegateForUpdate();
		updated.setFullDeptName(fullDeptName);
	...
	public String getCode() {
		if (isUpdated()) return updated.getCode();
