...
public class RealmAdapter implements CachedRealmModel {
    ...
    public List<PositionModel> searchForPositionByName(String search, Integer first, Integer max) {
        return cacheSession.searchForPositionByName(this, search, first, max);
    }

    @Override
    public List<PositionModel> searchForPositionByNameAndCode(String searchName, String searchCode, Integer first, Integer max) {
        return cacheSession.searchForPositionByNameAndCode(this, searchName, searchCode, first, max);
    }

    @Override
    public List<Integer> checkPositionByNameAndCode(String searchName, String searchCode) {
        return cacheSession.checkPositionByNameAndCode(this , searchName, searchCode);
    }
    @Override
    public PositionModel getPositionById(String id) {
        return cacheSession.getPositionById(id, this);
    }
    @Override
    public boolean removePosition(PositionModel position) {
        return cacheSession.removePosition(this, position);
    }
    @Override
