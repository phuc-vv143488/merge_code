...
import org.keycloak.models.cache.infinispan.stream.*;
...
public class RealmCacheManager extends CacheManager {
    ...
    // SP_POSITION
    public void positionQueriesInvalidations(String realmId, Set<String> invalidations) {
        invalidations.add(RealmCacheSession.getPositionsQueryCacheKey(realmId));
        addInvalidations(PositionListPredicate.create().realm(realmId), invalidations);
    }
    // SP_POSITION
}
