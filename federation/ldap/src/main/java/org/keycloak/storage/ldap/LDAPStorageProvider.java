...
public class LDAPStorageProvider implements UserStorageProvider,
    ...
    public List<UserModel> getPositionMembers(RealmModel realm, PositionModel position, int firstResult, int maxResults) {
        ...
        for (ComponentModel mapperModel : sortedMappers) {
            LDAPStorageMapper ldapMapper = mapperManager.getMapper(mapperModel);
            List<UserModel> users = ldapMapper.getPositionMembers(realm, position, firstResult, maxResults);
    ...
    public UserModel getPositionMember(RealmModel realm, PositionModel position, String userId) {
        ...
        for (ComponentModel mapperModel : sortedMappers) {
            LDAPStorageMapper ldapMapper = mapperManager.getMapper(mapperModel);
            UserModel user = ldapMapper.getPositionMember(realm, position, userId);
