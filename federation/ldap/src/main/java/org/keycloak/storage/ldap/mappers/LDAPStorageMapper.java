...
public interface LDAPStorageMapper extends Provider {
     ...
     * SP_POSITION
     *
     * Return empty list if doesn't support storing of positions
     */
    List<UserModel> getPositionMembers(RealmModel realm, PositionModel position, int firstResult, int maxResults);
    UserModel getPositionMember(RealmModel realm, PositionModel position, String userId);
}
