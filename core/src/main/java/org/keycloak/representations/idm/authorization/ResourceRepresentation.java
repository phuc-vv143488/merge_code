...
public class ResourceRepresentation {
    ...
    public ResourceRepresentation(String name, Set<String> uris, String type, String iconUri,
			ResourceOwnerRepresentation owner, String displayName, String parentId,Long order, Boolean haveChild) {
		super();
		this.name = name;
		this.uris = uris;
		this.type = type;
