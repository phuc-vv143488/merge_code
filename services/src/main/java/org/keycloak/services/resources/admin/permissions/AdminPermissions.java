    ...
    public static void registerListener(ProviderEventManager manager) {
        manager.register(new ProviderEventListener() {
            ...
            public void onEvent(ProviderEvent event) {
                ...
                // SP_POSITION
                else if (event instanceof PositionModel.PositionRemovedEvent) {
                    PositionModel.PositionRemovedEvent cast = (PositionModel.PositionRemovedEvent)event;
                    management(cast.getKeycloakSession(), cast.getRealm()).positions().setPermissionsEnabled(cast.getPosition(), false);
                }
                // SP_POSITION
            }
        });
