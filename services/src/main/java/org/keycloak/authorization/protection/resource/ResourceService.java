...
public class ResourceService {
    ...
    public Response find(@QueryParam("_id") String id,
        ...
        if(deep != null && deep) {
            return resourceManager.find(id, name, uri, owner, type, scope, matchingUri, exactName, deep, firstResult, maxResult, parentId);
        } else {
            return resourceManager.find(id, name, uri, owner, type, scope, matchingUri, exactName, deep, firstResult, maxResult, parentId, (BiFunction<Resource, Boolean, String>) (resource, deep1) -> resource.getId());
        }
    }
